...
//    盐值
    private final String slat = "asdflkjga@#$%^&^";
    @Override
    ...
    public SeckillExecution executeSeckill(long seckillId, long usePhone, String md5)
        ...
        try {
            ...
            if (updateCount <= 0) {
                ...
                if (insertCount <= 0) {
                    ...
                    return new SeckillExecution(seckillId, SeckillStatEnum.SUCCCESS, successKilled);
                }
            }
